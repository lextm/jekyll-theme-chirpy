...
[I wrote a language server prototype]({% post_url 2017/2017-12-23-a-new-restructuredtext-project %}) for reStructuredText in 2017 (let's call it rst-antlr), which helped create some basic functionality in the reStructuredText VSCode extension. But in the next few years I didn't have too much time to extend it further.
