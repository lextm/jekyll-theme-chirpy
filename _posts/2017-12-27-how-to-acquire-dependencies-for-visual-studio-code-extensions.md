...
So in my case, I had to write a reStructuredText parser on my own (as I met difficulty using existing ones), but [when I tried to build a Language Server]({% post_url 2017-12-26-how-to-write-your-language-server-in-c %}), there are already frameworks for me to choose from.
